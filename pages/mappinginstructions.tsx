                ...
                <div className="instructions__container">
                    <section>
                        ...
                        <p className="co_map_mediumtext">
                            ...
                            платформа вроде Википедии, информацию на который
                    ...
                    <section>
                        ...
                        <p className="instructions__img-block co_map_mediumtext">
                            ...
                            большинстве регионов и тем. (В исключительных
                            случаях изменение должно быть одобрено
                            амбассадором.)
                            <ol className="co_map_mediumtext">
                                ...
                                <li>
                                    ...
                                    логично. С ключевыми словами подумайте,
                                    какие термины можно отфильтровать
                                    <ul className="instructions__mark-list co_map_mediumtext">
                                        <li>
                                            События : ориентированные на смысл
                                            организации, которые стремятся к
                                            устойчивому развитию.
                                        </li>
                                        <li>
                                            Проекты : Ориентированные на
                                            потребности поставщики услуг и
                                            производители, речь идет об
                                ...
                                <li>
                                    ...
                                    сохранения (шаблон внизу). И подпишитесь на
                                    свой регион, чтобы быть в курсе изменений в
                                    ваших списках (подробности ниже).
                                </li>
                                <li>
                                    Во время следующей экскурсии по городу вы
                                    можете лично поздороваться с магазином и
                        ...
                        <div className="instructions__for-users">
                            <p className="co_map_mediumtext">
                                <Image
                                    ...
                                    className="instructions__img-map2"
                                />
                                Прежде всего: Только <b>амбассадоры</b> могут
                                удалять записи. Если вы хотите удалить что-то
                                как обычный пользователь, но не имеете
                                необходимых прав, то просто отредактируйте
                                запись и используйте одно из следующих ключевых
                                слов:
                            </p>
                            <ol className="co_map_mediumtext">
                            ...
                            <p className="co_map_mediumtext">
                                Тогда амбассадор в вашем регионе быстро
                                разберется с этим. Кроме того, вы можете
                                воспользоваться кнопкой в нижнем колонтитуле
                                записи "Пожаловаться на запись", чтобы отправить
                                сообщение непосредственно в редакцию.
                            </p>
                        </div>
                    </section>
                    <section>
                    ...
                    <section>
                        ...
                        <p className="co_map_mediumtext">
                            Почему место, которое я ищу, не найдено? Поиск на
                            главной странице довольно чувствителен. Важно ввести
                            именно то название, которое использует карта.
                        ...
                        <p className="co_map_mediumtext">
                            ...
                            коммуникации английский вопрос)
                        </p>
                    </section>
                    <section>
                        <h2 className="co_map_largetext">
                    ...
                    <section>
                        ...
                        <p className="co_map_mediumtext">
                            ...
                            участников вашей сети и мероприятия. Как это
                    ...
                    <section>
                        ...
                        <p className="co_map_mediumtext">
                            ...
                            прозрачность: Компании могут быть оценены всеми
                        ...
                        <p className="co_map_mediumtext">
                            При добавлении на карту компании или события,
                            предоставляется шесть отраслевых направлений на
                            выбор:
                        </p>
                        <Image
                            src={
                        ...
                        <p className="co_map_mediumtext">
                            ...
                            амбассадоры, а также сами проекты и компании имеют
                        ...
                        <p className="co_map_mediumtext">
                            ...
                            развития. К каждой компании или событию может быть
                            добавлено любое количество различных характеристик,
                            которые обсуждаются и оцениваются всеми
                            пользователями.{' '}
                        </p>
